...
import GetSalarySlips from "./components/All-Modules/Employee Module/Employee-Documents/GetSalarySlips";
  ...
  return (
    <>
      <Routes>
        ...
        ></Route>
        <Route
          path="/get-salaryslips"
          element={<PrivateRouteAxis children={<GetSalarySlips />} />}
        ></Route>
        <Route
